...
Pendências: 
* Criar arquivo de log para registrar info, warnings e erros;
* Criar folha em planilha para CNPJs inválidos;
* Adicionar opções para salvar arquivo de saída nos formatos .xlsx e .csv;
* Adcionar opções para abrir arquivo de lista no formato .csv;
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
...
=======
logging.basicConfig(
    filename='simples_nacional.log',      # Nome do arquivo de log
    level=logging.INFO,                   # Nível mínimo de log
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
...
=======
    ...
    def Processar_Dados(self, dados_brutos, arquivo_saida):
        # Cria o DataFrame
        df = pd.DataFrame(dados_brutos, columns=['CNPJ', 'Apuração', 'Vencimento', 'Inclusão', 'VL. Originário(R$)', 'Saldo Devedor(R$)', 'Parcelamento', 'Ind CT Exc'])
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
...
=======
                logging.warning("Planilha não salva pelo usuário.")
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
...
=======
                         inicio=0, fim=0, arquivo_leitura=None, arquivo_saida=None):
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
...
=======
    ...
    console.exibir_mensagem("Teste de Consulta de lista de Débitos")
    simples_nacional.ConsultaDebitos("01/2019", "12/2024", lista=True, 
                                      cnpj="42107457000140", 
                                      inicio=2, fim=5,
                                      arquivo_leitura="C:/Users/welton.rosa/Documents/erros.xlsx", 
                                      arquivo_saida="C:/Users/welton.rosa/Documents/Debitos.xlsx")    
 """
>>>>>>> e77c940cafd5b1663f8aa221179b99075ca41f83
